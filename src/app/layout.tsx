...
export const metadata: Metadata = {
  title: {
    default: "Magneto CRM",
    template: "%s — Magneto CRM",
  },
  description: "Magneto365IA — WhatsApp Business CRM with AI agents, automations, and team collaboration.",
  robots: {
    index: false,
    follow: false,
  },
...
export default async function RootLayout({
  ...
  // The middleware sets x-nonce on the forwarded request headers.
  // Read it here so we can pass it to <Script> for CSP compliance.
